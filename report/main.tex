...
We have some effective methods to get a numerical approximation of the polar decomposition, such as the \emph{Hally's method}\cite{nakatsukasa2010optimizing}
...
\[ \lim_{k\to \infty} s_k=0,\qquad \sum_{k>0}s_k \text{diverges}.\]
